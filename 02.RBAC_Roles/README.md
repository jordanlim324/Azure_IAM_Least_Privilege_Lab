...
## Decisions Made
   -  Decisions
      - Administrator Decisions
         ...
         - While assigning the Administrator role, I noticed that Azure's role picker separated "Job Function Roles" and "Privileged Administrator Roles." Contributor was used because the administrator persona required broad resource-management permissions within the resource group, but should not have Azure RBAC role-assignment authority/functionality.
      ...
      - Employee Decisions
         ...
         - I noted that the employee custom role was classified as a privileged administrator role as it contains wildcard read and write permissions. Based on Microsoft's own documentation, this classification is based on scope of granted permissions. Broad write access, specifically, automatically placed this custom role within the privileged administrator role, and warrants careful consideration for such powerful permissions.
         ...
         - This employee role should not be considered a true least-privilege implementation. The current implementation exists as a design decision that I had documented in the above bullet point, and serves as a demonstration as to why resource-specific permissions are preferable to wildcard write permissions.
      - Contractor Decisions
         - Initially looked to create a custom role, but realized that there was a built-in "Reader" role that fit my needs.


## Screenshots
- Creating Role Assignment for "sg-shirabuki-admins"<br>
![Microsoft Azure screenshot of Admin Role Assignment](Screenshots/Administrator_Security_Group_Role_Assignment.png)

- Creating Custom Role for "sg-shirabuki-employees"<br>
![Microsoft Azure screenshot of Custom Employee Role](Screenshots/Employee_Security_Group_Role_Creation.png)

- Creating Role Assignment for "sg-shirabuki-employees"<br>
![Microsoft Azure screenshot of Employee Role Assignment](Screenshots/Employee_Security_Group_Role_Assignment.png)

- Creating Role Assignment for "sg-shirabuki-contractors"<br>
![Microsoft Azure screenshot of Contractor Role Assignment](Screenshots/Contractor_Security_Group_Role_Assignment.png)

- List of Role Assignments<br>
